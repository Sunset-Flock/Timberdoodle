    ...
    if (ImGui::Begin("Renderer Settings", nullptr, ImGuiWindowFlags_NoCollapse))
    {
        ...
        ImGui::SeparatorText("Features");
        {
            ...
            if (ImGui::CollapsingHeader("RTGI Settings"))
            {
                ...
                ImGui::Checkbox("Spatial Filter Two Pass Enabled", reinterpret_cast<bool *>(&render_data.rtgi_settings.spatial_filter_two_pass_enabled));
                ImGui::Checkbox("Spatial Post Blur Enabled", reinterpret_cast<bool *>(&render_data.rtgi_settings.post_blur_enabled));
