...
namespace RenderTimes
{
    ...
    enum RenderTimesEnum
    {
        ...
        SHADE_OPAQUE,
        SHADE_GBUFFER,
        ASTEROIDS_INTIALIZE_HASHING,
        ASTEROIDS_RADIX_PASS_ONE,
        ASTEROIDS_RADIX_PASS_TWO,
        ASTEROIDS_RADIX_PASS_THREE,
        ASTEROIDS_RADIX_PASS_FOUR,
        ASTEROIDS_FINALIZE_HASHING,
        ASTEROIDS_MATERIAL_UPDATE,
        ASTEROIDS_DERIVATIVE_CALCULATION,
        ASTEROIDS_EQUATION_UPDATE,
        COUNT,
    };
    ...
    enum RenderGroupTimesEnum
    {
        ...
        // GROUP_ASTEROID_SIMULATION,
        GROUP_ASTEROIDS_INTIALIZE_HASHING,
        GROUP_ASTEROIDS_RADIX_PASS_ONE,
        GROUP_ASTEROIDS_RADIX_PASS_TWO,
        GROUP_ASTEROIDS_RADIX_PASS_THREE,
        GROUP_ASTEROIDS_RADIX_PASS_FOUR,
        GROUP_ASTEROIDS_FINALIZE_HASHING,
        GROUP_ASTEROIDS_MATERIAL_UPDATE,
        GROUP_ASTEROIDS_DERIVATIVE_CALCULATION,
        GROUP_ASTEROIDS_EQUATION_UPDATE,
        GROUP_ASTEROIDS_TOTAL,
        GROUP_COUNT
    };

    static constexpr inline std::array<char const *, RenderGroupTimesEnum::GROUP_COUNT> GROUP_NAMES = {
        "ASTEROIDS_INTIALIZE_HASHING",
        "ASTEROIDS_RADIX_PASS_ONE",
        "ASTEROIDS_RADIX_PASS_TWO",
        "ASTEROIDS_RADIX_PASS_THREE",
    ...
    static constexpr inline std::array GROUP_ASTEROIDS_SIMULATION_TIMES = std::array{
        ASTEROIDS_INTIALIZE_HASHING,
        ASTEROIDS_RADIX_PASS_ONE,
        ASTEROIDS_RADIX_PASS_TWO,
        ASTEROIDS_RADIX_PASS_THREE,
    ...
    static constexpr inline std::array GROUP_ASTEROIDS_INTIALIZE_HASHING_TIMES = std::array{ASTEROIDS_INTIALIZE_HASHING};
    static constexpr inline std::array GROUP_ASTEROIDS_RADIX_PASS_ONE_TIMES = std::array{ASTEROIDS_RADIX_PASS_ONE};
    static constexpr inline std::array GROUP_ASTEROIDS_RADIX_PASS_TWO_TIMES = std::array{ASTEROIDS_RADIX_PASS_TWO};
    static constexpr inline std::array GROUP_ASTEROIDS_RADIX_PASS_THREE_TIMES = std::array{ASTEROIDS_RADIX_PASS_THREE};
    static constexpr inline std::array GROUP_ASTEROIDS_RADIX_PASS_FOUR_TIMES = std::array{ASTEROIDS_RADIX_PASS_FOUR};
    static constexpr inline std::array GROUP_ASTEROIDS_FINALIZE_HASHING_TIMES = std::array{ASTEROIDS_FINALIZE_HASHING};
    static constexpr inline std::array GROUP_ASTEROIDS_MATERIAL_UPDATE_TIMES = std::array{ASTEROIDS_MATERIAL_UPDATE};
    static constexpr inline std::array GROUP_ASTEROIDS_DERIVATIVE_CALCULATION_TIMES = std::array{ASTEROIDS_DERIVATIVE_CALCULATION};
    static constexpr inline std::array GROUP_ASTEROIDS_EQUATION_UPDATE_TIMES = std::array{ASTEROIDS_EQUATION_UPDATE};

    static constexpr inline std::array<std::span<RenderTimesEnum const>, GROUP_COUNT> GROUP_RENDER_TIMES = {
        GROUP_ASTEROIDS_INTIALIZE_HASHING_TIMES,
        GROUP_ASTEROIDS_RADIX_PASS_ONE_TIMES,
        GROUP_ASTEROIDS_RADIX_PASS_TWO_TIMES,
        GROUP_ASTEROIDS_RADIX_PASS_THREE_TIMES,
        GROUP_ASTEROIDS_RADIX_PASS_FOUR_TIMES,
        GROUP_ASTEROIDS_FINALIZE_HASHING_TIMES,
        GROUP_ASTEROIDS_MATERIAL_UPDATE_TIMES,
        GROUP_ASTEROIDS_DERIVATIVE_CALCULATION_TIMES,
        GROUP_ASTEROIDS_EQUATION_UPDATE_TIMES,
        GROUP_ASTEROIDS_SIMULATION_TIMES,
    };
