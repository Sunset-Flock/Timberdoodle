...
DAXA_TH_BUFFER_PTR(GRAPHICS_SHADER_READ, daxa_u64, po2expansion)
DAXA_TH_BUFFER_PTR(GRAPHICS_SHADER_READ, daxa_u64, masked_po2expansion)
// Draw Attachments:
...
struct CullAndDrawPagesTask : CullAndDrawPagesH::Task
{
    ...
    void callback(daxa::TaskInterface ti)
    {
        ...
        *reinterpret_cast<CullAndDrawPagesH::AttachmentShaderBlob*>(attachment_alloc.host_address) = ti.attachment_shader_blob;
        ...
        {
            auto buffer = opaque_draw_list_type == PREPASS_DRAW_LIST_OPAQUE ? ti.get(AT.po2expansion).ids[0] : ti.get(AT.masked_po2expansion).ids[0];
...
inline void task_draw_vsms(TaskDrawVSMsInfo const & info)
{
    ...
    info.tg->add_task(CullAndDrawPagesTask{
        .views = std::array{
            ...
            daxa::attachment_view(CullAndDrawPagesH::AT.po2expansion, directional_cascade_meshlet_expansions[0]),
            daxa::attachment_view(CullAndDrawPagesH::AT.masked_po2expansion, directional_cascade_meshlet_expansions[1]),
