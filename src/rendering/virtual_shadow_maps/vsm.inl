...
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DId<daxa_f32>, g_buffer_depth)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DId<daxa_u32>, g_buffer_face_normal)
...
DAXA_TH_BUFFER_PTR(READ_WRITE_CONCURRENT, daxa_BufferPtr(RenderGlobalData), globals)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_point_spot_page_table)
...
// Vsm Attachments:
DAXA_TH_BUFFER_PTR(READ, daxa_BufferPtr(VSMClipProjection), vsm_clip_projections)
DAXA_TH_IMAGE_ID(SAMPLE, REGULAR_2D_ARRAY, vsm_dirty_bit_hiz)
...
// Hpb Attachments:
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip0)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip1)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip2)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip3)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip4)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip5)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_dirty_bit_hiz_mip6)
DAXA_DECL_TASK_HEAD_END
...
DAXA_TH_BUFFER_PTR(READ_WRITE_CONCURRENT, daxa_BufferPtr(RenderGlobalData), globals)
DAXA_TH_BUFFER_PTR(READ, daxa_BufferPtr(VSMClipProjection), vsm_clip_projections)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::Texture2DArrayId<daxa_u32>, vsm_page_table)
...
DAXA_TH_BUFFER_PTR(READ, daxa_BufferPtr(VSMAllocationRequestsHeader), vsm_allocation_requests)
DAXA_TH_BUFFER_PTR(READ, daxa_BufferPtr(FindFreePagesHeader), vsm_find_free_pages_header)
DAXA_TH_IMAGE_TYPED(SAMPLE, daxa::RWTexture2DId<daxa_u64>, vsm_meta_memory_table)
DAXA_DECL_TASK_HEAD_END
#endif
