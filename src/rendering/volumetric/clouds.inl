...
#define RAYMARCH_VOLUMETRIC_SHADOW_MAP_DISPATCH_X 64

DAXA_DECL_COMPUTE_TASK_HEAD_BEGIN(RaymarchCloudVolumetricShadowMap)
DAXA_TH_BUFFER_PTR(READ_WRITE_CONCURRENT, daxa_RWBufferPtr(RenderGlobalData), globals)
DAXA_TH_BUFFER_PTR(READ, daxa_BufferPtr(CloudVolumeInstancesBufferHead), cloud_volumes)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture3DId<daxa_f32vec2>, cloud_volumetric_shadow_map)
DAXA_DECL_TASK_HEAD_END

struct RaymarchCloudVolumetricShadowMapPush
{
    daxa_BufferPtr(RaymarchCloudVolumetricShadowMap::AttachmentShaderBlob) attach;
    daxa_u32vec3 volumetric_resolution;
};
