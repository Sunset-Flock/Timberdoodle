...
{
    SkySettings * settings = &transmittance_push.globals.sky_settings;
...
{
    SkySettings * settings = info.settings;
...
)
{
    ...
    SkySettings * settings = &multiscattering_push.globals.sky_settings;
...
{
    SkySettings * settings = &sky_push.globals.sky_settings;
