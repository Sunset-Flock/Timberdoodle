...
DAXA_TH_IMAGE_TYPED_ID(COMPUTE_SHADER_STORAGE_WRITE_ONLY, RWTexture2DId<daxa_f32vec3>, color_image)
DAXA_TH_IMAGE_TYPED_ID(COMPUTE_SHADER_STORAGE_READ_ONLY, RWTexture2DId<daxa_f32>, ao_image)
...
DAXA_TH_IMAGE_ID(COMPUTE_SHADER_STORAGE_READ_ONLY, REGULAR_2D, atomic_visbuffer)  // OPTIONAL
