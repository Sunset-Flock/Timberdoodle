...
DAXA_DECL_TASK_HEAD_BEGIN(ComputeMultiscatteringH, 3)
DAXA_TH_BUFFER_PTR(COMPUTE_SHADER_READ_WRITE_CONCURRENT, daxa_BufferPtr(RenderGlobalData), globals)
...
DAXA_DECL_TASK_HEAD_BEGIN(ComputeSkyH, 4)
DAXA_TH_BUFFER_PTR(COMPUTE_SHADER_READ_WRITE_CONCURRENT, daxa_BufferPtr(RenderGlobalData), globals)
DAXA_TH_IMAGE_ID(COMPUTE_SHADER_SAMPLED, REGULAR_2D, transmittance)
...
DAXA_DECL_TASK_HEAD_BEGIN(SkyIntoCubemapH, 4)
DAXA_TH_BUFFER_PTR(COMPUTE_SHADER_READ_WRITE_CONCURRENT, daxa_BufferPtr(RenderGlobalData), globals)
DAXA_TH_IMAGE_ID(COMPUTE_SHADER_SAMPLED, REGULAR_2D, transmittance)
...
struct ComputeTransmittanceTask : ComputeTransmittanceH::Task
{
    ...
    {
        auto const transmittance_size = context->device.info_image(ti.get(AT.transmittance).ids[0]).value().size;
