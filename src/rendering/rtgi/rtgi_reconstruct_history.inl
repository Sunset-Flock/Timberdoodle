...
#define RTGI_RECONSTRUCT_HISTORY_DIFFUSE_X 16
#define RTGI_RECONSTRUCT_HISTORY_DIFFUSE_Y 16

DAXA_DECL_COMPUTE_TASK_HEAD_BEGIN(RtgiDiffuseReconstructHistoryH)
...
struct RtgiDiffuseReconstructHistoryPush
{
    RtgiDiffuseReconstructHistoryH::AttachmentShaderBlob attach;
    daxa_u32vec2 size;
};