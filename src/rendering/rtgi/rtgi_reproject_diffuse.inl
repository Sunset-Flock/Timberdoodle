...
DAXA_TH_IMAGE_TYPED(READ, daxa::RWTexture2DIndex<daxa_f32vec4>, rtgi_diffuse_raw)
DAXA_TH_IMAGE_TYPED(READ, daxa::RWTexture2DIndex<daxa_f32vec2>, rtgi_diffuse2_raw)
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DIndex<daxa_f32vec4>, rtgi_diffuse_history)
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DIndex<daxa_f32vec2>, rtgi_diffuse2_history)
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DIndex<daxa_f32vec4>, rtgi_diffuse_stable_history)
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DIndex<daxa_f32vec2>, rtgi_diffuse2_stable_history)
...
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec4>, rtgi_diffuse_accumulated)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec2>, rtgi_diffuse2_accumulated)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec4>, rtgi_diffuse_stable_reprojected)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec2>, rtgi_diffuse2_stable_reprojected)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec4>, rtgi_diffuse_high_energy)
DAXA_TH_IMAGE_TYPED(WRITE, daxa::RWTexture2DIndex<daxa_f32vec2>, rtgi_diffuse2_high_energy)
...
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DId<daxa_f32vec4>, rtgi_diffuse_stable_history_reprojected)
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DId<daxa_f32vec2>, rtgi_diffuse2_stable_history_reprojected)
