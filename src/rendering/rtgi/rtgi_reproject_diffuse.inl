...
DAXA_TH_IMAGE_TYPED(READ, daxa::RWTexture2DId<daxa_f32vec2>, rtgi_diffuse2_raw)
...
DAXA_TH_IMAGE_TYPED(SAMPLED, daxa::Texture2DId<daxa_u32>, rtgi_face_normal_history)
