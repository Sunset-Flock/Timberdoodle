...
#define PGI_DEBUG_PROBE_DRAW_MODE_RADIANCE 2
#define PGI_DEBUG_PROBE_DRAW_MODE_RADIANCE_REFLECTION 3
#define PGI_DEBUG_PROBE_DRAW_MODE_DISTANCE 4
#define PGI_DEBUG_PROBE_DRAW_MODE_UNCERTAINTY 5
#define PGI_DEBUG_PROBE_DRAW_MODE_COLOR_TEXEL 6
#define PGI_DEBUG_PROBE_DRAW_MODE_DEPTH_TEXEL 7
#define PGI_DEBUG_PROBE_DRAW_MODE_UV 8
#define PGI_DEBUG_PROBE_DRAW_MODE_NORMAL 9
#define PGI_DEBUG_PROBE_DRAW_MODE_HYSTERESIS 10
