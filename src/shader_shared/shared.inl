...
#define USE_TASK_HEAD(HEAD) HEAD::Uses uses; static inline constexpr std::string_view NAME = HEAD::NAME; std::string name = std::string(HEAD::NAME.data(), HEAD::NAME.size());