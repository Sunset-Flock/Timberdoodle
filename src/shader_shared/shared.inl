...
#define ASTEROID_DEBUG_DRAW_MODE_NONE 0
#define ASTEROID_DEBUG_DRAW_MODE_VELOCITY 1
#define ASTEROID_DEBUG_DRAW_MODE_ACCELERATION 2
#define ASTEROID_DEBUG_DRAW_MODE_VELOCITY_DIVERGENCE 3
#define ASTEROID_DEBUG_DRAW_MODE_PRESSURE 4
#define ASTEROID_DEBUG_DRAW_MODE_DENSITY 5
struct AsteroidSettings
{
    ...
    daxa_f32 dt TIDO_DEFAULT_VALUE(0.001);
};
