...
struct RtgiSettings
{
    ...
    daxa_i32 disocclusion_filter_enabled TIDO_DEFAULT_VALUE(0);
    daxa_i32 spatial_filter_enabled TIDO_DEFAULT_VALUE(1);
    daxa_i32 spatial_filter_two_pass_enabled TIDO_DEFAULT_VALUE(0);
    ...
    daxa_f32 spatial_filter_width TIDO_DEFAULT_VALUE(4);
};